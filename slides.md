...
当時、同じく各地で登壇されていたk1LoWさんとは、同じ場所に採択され、現地でrunnの開発者会議を開くチャンスを狙って、プロポーザルを出し続けていた中のサイクルでした。
-->
...
<!--
こちらが実際に書いたものです。興味があればぜひよろしくお願いします。無料です！
-->
...
飛び込みLTでスキーマ駆動開発のフローを発表したところ、フィードバックがもらえ、それがeg-r2というライブラリのOSS化につながりました。  
...
この流れを意識してからは、OSS活動を続ける行動に自然と変わっていきました。
-->
